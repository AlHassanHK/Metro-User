...
const updateSubscription = async (req, res) => {
  ...
  try {
    const newSeniorRequest = await subscription.create({
      data: {
        id:uuid(),        
        type:      subscriptionType=="Monthly"? SubscriptionType.Monthly :  subscriptionType== 'Quarterly'? SubscriptionType.Quarterly:subscriptionType== 'Annual'? SubscriptionType.Annual  ,
        expiryDate: new Date(),
      },
    });
